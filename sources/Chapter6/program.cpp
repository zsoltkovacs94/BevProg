...
constexpr char quit = 'x';	//2. feladat a quit átírva x-re
constexpr char print = '=';	//3. feladat a print átírva =-re
...
try {
	...
	cout << "Welcome to our simple calculator.\nPlease enter expressions using floating-point numbers.\nAvailable operators are '+','-','*','/','%' \nenter '"<<print<<"' to print out the answer, and enter '"<<quit<<"' to quit.\n";
